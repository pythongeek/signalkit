...
class SignalKit_Settings {
    ...
    public function register_settings() {
        ...
        // Note: register_setting() is called by SignalKit_Admin::register_settings()
        // This method only registers settings sections and fields for the alternative settings page
    ...
    private function register_all_fields() {
        ...
        add_settings_field(
            'signalkit_delete_data_on_uninstall',
            __('Delete Data on Uninstall', 'signalkit'),
            array($this, 'checkbox_field_callback'),
            'signalkit-settings',
            'signalkit_general_section',
            array('field' => 'delete_data_on_uninstall', 'description' => __('Check this to delete all plugin data when the plugin is uninstalled.', 'signalkit'))
        );
