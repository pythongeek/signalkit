...
$defaults = array(
    ...
    // Follow Banner - Enhanced Style Settings v2.0
    ...
    // Preferred Banner - Enhanced Style Settings v2.0
    ...
    'mobile_banner_strategy' => 'show_all', // show_all, priority_only, rotate
    
    // Data Management - Envato/WordPress.org compliance (default: preserve data)
    ...
    <div class="signalkit-layout-container">
            ...
            <div class="signalkit-tabs-container">
                <nav class="signalkit-tabs" role="tablist">
                    <button type="button" class="signalkit-tab active" data-tab="follow" role="tab" aria-selected="true" aria-controls="tab-follow">
                        ...
                        <?php esc_html_e('Follow Banner', 'signalkit'); ?>
                    </button>
                    <button type="button" class="signalkit-tab" data-tab="preferred" role="tab" aria-selected="false" aria-controls="tab-preferred">
                        ...
                        <?php esc_html_e('Preferred Source', 'signalkit'); ?>
                    </button>
                    <button type="button" class="signalkit-tab" data-tab="custom" role="tab" aria-selected="false" aria-controls="tab-custom">
                        <span class="dashicons dashicons-email-alt" aria-hidden="true"></span>
                        <?php esc_html_e('Custom Banner', 'signalkit'); ?>
                    </button>
                    <button type="button" class="signalkit-tab" data-tab="global" role="tab" aria-selected="false" aria-controls="tab-global">
                        ...
                        <?php esc_html_e('Global Settings', 'signalkit'); ?>
                    </button>
                    <button type="button" class="signalkit-tab" data-tab="advanced" role="tab" aria-selected="false" aria-controls="tab-advanced">
                        ...
                        <?php esc_html_e('Advanced & Security', 'signalkit'); ?>
                    </button>
                </nav>
                ...
                <form method="post" action="options.php" class="signalkit-form" novalidate>
                        ...
                        <div class="signalkit-settings-grid">
                            ...
                            <div class="signalkit-setting-row">
                                ...
                                <div class="signalkit-setting-info">
                                    <strong><?php esc_html_e('Enable Follow Banner', 'signalkit'); ?></strong>
                                    <p id="follow-enabled-desc"><?php esc_html_e('Display the Follow banner on your site to grow your news audience', 'signalkit'); ?></p>
                                </div>
                            </div>
                            
                            <div class="signalkit-setting-row">
                                <label for="follow_google_news_url"><?php esc_html_e('Google News URL', 'signalkit'); ?> <span class="required" aria-label="<?php esc_attr_e('required', 'signalkit'); ?>">*</span></label>
                                <input type="url" 
                                       ...
                                       required>
                                <p class="description" id="follow-url-desc"><?php esc_html_e('Your Google News publication URL', 'signalkit'); ?></p>
                            </div>
                            ...
                            <div class="signalkit-setting-row">
                                <label for="follow_banner_headline"><?php esc_html_e('Banner Headline', 'signalkit'); ?></label>
                                <input type="text" 
                                ...
                                <p class="description" id="follow-headline-desc"><?php esc_html_e('Use [site_name] as placeholder for your site name', 'signalkit'); ?></p>
                            </div>
                            
                            <div class="signalkit-setting-row">
                                <label for="follow_banner_description"><?php esc_html_e('Banner Description', 'signalkit'); ?></label>
                            ...
                            <div class="signalkit-setting-row">
                                <label for="follow_button_text"><?php esc_html_e('Button Text', 'signalkit'); ?></label>
                                <input type="text" 
                            ...
                            <div class="signalkit-section-header">
                                <h3><span class="dashicons dashicons-art" aria-hidden="true"></span> <?php esc_html_e('Design & Appearance', 'signalkit'); ?></h3>
                            </div>
                            
                            <div class="signalkit-setting-row signalkit-color-row">
                                <h4><?php esc_html_e('Colors', 'signalkit'); ?></h4>
                                <div class="signalkit-color-grid">
                                    <div class="signalkit-color-input">
                                        <label for="follow_primary_color"><?php esc_html_e('Primary Color', 'signalkit'); ?></label>
                                        <input type="text" 
                                    ...
                                    <div class="signalkit-color-input">
                                        <label for="follow_secondary_color"><?php esc_html_e('Secondary Color', 'signalkit'); ?></label>
                                        <input type="text" 
                                    ...
                                    <div class="signalkit-color-input">
                                        <label for="follow_accent_color"><?php esc_html_e('Accent Color', 'signalkit'); ?></label>
                                        <input type="text" 
                                    ...
                                    <div class="signalkit-color-input">
                                        <label for="follow_text_color"><?php esc_html_e('Text Color', 'signalkit'); ?></label>
                                        <input type="text" 
                                    ...
                                    <div class="signalkit-color-input">
                                        <label for="follow_button_text_color"><?php esc_html_e('Button Text Color', 'signalkit'); ?></label>
                                        <input type="text" 
                                    ...
                                    <div class="signalkit-color-input">
                                        <label for="follow_button_bg_color"><?php esc_html_e('Button BG Color', 'signalkit'); ?></label>
                                        <input type="text" 
                            ...
                            <div class="signalkit-setting-row">
                                <h4><?php esc_html_e('Size & Spacing', 'signalkit'); ?></h4>
                                <div class="signalkit-size-grid">
                                    <div class="signalkit-size-input">
                                        <label for="follow_banner_width"><?php esc_html_e('Banner Width (px)', 'signalkit'); ?></label>
                                        <input type="number" 
                            ...
                            <div class="signalkit-setting-row">
                                <h4><?php esc_html_e('Typography', 'signalkit'); ?></h4>
                                <div class="signalkit-typography-grid">
                                    <div class="signalkit-typography-input">
                                        <label for="follow_font_size_headline"><?php esc_html_e('Headline Size (px)', 'signalkit'); ?></label>
                                        <input type="number" 
                            ...
                            <div class="signalkit-setting-row">
                                <div class="signalkit-display-grid">
                                    <div class="signalkit-select-group">
                                        <label for="follow_position"><?php esc_html_e('Desktop Position', 'signalkit'); ?></label>
                                    ...
                                    <div class="signalkit-select-group">
                                        <label for="follow_mobile_position"><?php esc_html_e('Mobile Position', 'signalkit'); ?></label>
                                    ...
                                    <div class="signalkit-select-group">
                                        <label for="follow_animation"><?php esc_html_e('Animation', 'signalkit'); ?></label>
                            ...
                            <div class="signalkit-setting-row">
                                ...
                                <div class="signalkit-setting-info">
                                    <strong><?php esc_html_e('Allow Dismissal', 'signalkit'); ?></strong>
                                    <p id="follow-dismissible-desc"><?php esc_html_e('Users can close the banner', 'signalkit'); ?></p>
                                </div>
                            </div>

                            <div class="signalkit-setting-row">
                                <label for="follow_close_button_size"><?php esc_html_e('Close Button Size (px)', 'signalkit'); ?></label>
                            ...
                            <div class="signalkit-setting-row">
                                <label for="follow_dismiss_duration"><?php esc_html_e('Dismiss Duration (days)', 'signalkit'); ?></label>
                                <input type="number" 
                                ...
                                <p class="description" id="follow-dismiss-desc"><?php esc_html_e('How long to hide the banner after dismissal', 'signalkit'); ?></p>
                            </div>
                            
                            <div class="signalkit-setting-row">
                                <h4><?php esc_html_e('Device Settings', 'signalkit'); ?></h4>
                                <div class="signalkit-checkbox-group">
                                    <label>
                                        ...
                                        <?php esc_html_e('Show on Mobile', 'signalkit'); ?>
                                    </label>
                                    <label>
                                        <input type="checkbox" 
                                        ...
                                        <?php esc_html_e('Show on Desktop', 'signalkit'); ?>
                                    </label>
                                </div>
                            </div>
                            
                            <div class="signalkit-setting-row">
                                <h4><?php esc_html_e('Page Types', 'signalkit'); ?></h4>
                                <div class="signalkit-checkbox-group">
                                    <label>
                                        <input type="checkbox" 
                    ...
                    <div class="signalkit-tab-content" id="tab-preferred" data-content="preferred" role="tabpanel">
                        <div class="signalkit-settings-grid">
                            ...
                            <div class="signalkit-setting-row">
                                ...
                                <div class="signalkit-setting-info">
                                    <strong><?php esc_html_e('Enable Preferred Source Banner', 'signalkit'); ?></strong>
                                    <p id="preferred-enabled-desc"><?php esc_html_e('Display the Preferred Source banner on your site', 'signalkit'); ?></p>
                                </div>
                            </div>
                            
                            <div class="signalkit-setting-row">
                                <label for="preferred_google_preferences_url"><?php esc_html_e('Google Preferences URL', 'signalkit'); ?> <span class="required" aria-label="<?php esc_attr_e('required', 'signalkit'); ?>">*</span></label>
                                <input type="url" 
                                       ...
                                       required>
                                <p class="description" id="preferred-url-desc"><?php esc_html_e('Google News preferences URL where users can add your site as preferred', 'signalkit'); ?></p>
                            </div>
                            
                            <div class="signalkit-setting-row">
                                <label for="preferred_educational_post_url"><?php esc_html_e('Educational Post URL', 'signalkit'); ?></label>
                                <input type="url" 
                                ...
                                <p class="description" id="preferred-edu-desc"><?php esc_html_e('Link to a post explaining how to add preferred sources', 'signalkit'); ?></p>
                            </div>
                            ...
                            <div class="signalkit-setting-row">
                                ...
                                <div class="signalkit-setting-info">
                                    <strong><?php esc_html_e('Show Educational Link', 'signalkit'); ?></strong>
                                    <p id="preferred-show-edu-desc"><?php esc_html_e('Display a link to learn more about preferred sources', 'signalkit'); ?></p>
                                </div>
                            </div>
                            
                            <div class="signalkit-setting-row">
                                <label for="preferred_educational_text"><?php esc_html_e('Educational Link Text', 'signalkit'); ?></label>
                                <input type="text" 
                            ...
                            <div class="signalkit-setting-row">
                                <label for="preferred_banner_headline"><?php esc_html_e('Banner Headline', 'signalkit'); ?></label>
                                <input type="text" 
                                ...
                                <p class="description" id="preferred-headline-desc"><?php esc_html_e('Use [site_name] as placeholder for your site name', 'signalkit'); ?></p>
                            </div>
                            
                            <div class="signalkit-setting-row">
                                <label for="preferred_banner_description"><?php esc_html_e('Banner Description', 'signalkit'); ?></label>
                            ...
                            <div class="signalkit-setting-row">
                                <label for="preferred_button_text"><?php esc_html_e('Button Text', 'signalkit'); ?></label>
                                <input type="text" 
                            ...
                            <div class="signalkit-setting-row signalkit-color-row">
                                ...
                                <div class="signalkit-color-grid">
                                    <div class="signalkit-color-input">
                                        <label for="preferred_primary_color"><?php esc_html_e('Primary Color', 'signalkit'); ?></label>
                                        <input type="text" 
                                    ...
                                    <div class="signalkit-color-input">
                                        <label for="preferred_secondary_color"><?php esc_html_e('Secondary Color', 'signalkit'); ?></label>
                                        <input type="text" 
                                    ...
                                    <div class="signalkit-color-input">
                                        <label for="preferred_accent_color"><?php esc_html_e('Accent Color', 'signalkit'); ?></label>
                                        <input type="text" 
                                    ...
                                    <div class="signalkit-color-input">
                                        <label for="preferred_text_color"><?php esc_html_e('Text Color', 'signalkit'); ?></label>
                                        <input type="text" 
                                    ...
                                    <div class="signalkit-color-input">
                                        <label for="preferred_button_text_color"><?php esc_html_e('Button Text Color', 'signalkit'); ?></label>
                                        <input type="text" 
                                    ...
                                    <div class="signalkit-color-input">
                                        <label for="preferred_button_bg_color"><?php esc_html_e('Button BG Color', 'signalkit'); ?></label>
                                        <input type="text" 
                            ...
                            <div class="signalkit-setting-row">
                                ...
                                <div class="signalkit-size-grid">
                                    <div class="signalkit-size-input">
                                        <label for="preferred_banner_width"><?php esc_html_e('Banner Width (px)', 'signalkit'); ?></label>
                                        <input type="number" 
                            ...
                            <div class="signalkit-setting-row">
                                ...
                                <div class="signalkit-typography-grid">
                                    <div class="signalkit-typography-input">
                                        <label for="preferred_font_size_headline"><?php esc_html_e('Headline Size (px)', 'signalkit'); ?></label>
                                        <input type="number" 
                            ...
                            <div class="signalkit-setting-row">
                                <div class="signalkit-display-grid">
                                    <div class="signalkit-select-group">
                                        <label for="preferred_position"><?php esc_html_e('Desktop Position', 'signalkit'); ?></label>
                                    ...
                                    <div class="signalkit-select-group">
                                        <label for="preferred_mobile_position"><?php esc_html_e('Mobile Position', 'signalkit'); ?></label>
                                    ...
                                    <div class="signalkit-select-group">
                                        <label for="preferred_animation"><?php esc_html_e('Animation', 'signalkit'); ?></label>
                            ...
                            <div class="signalkit-setting-row">
                                ...
                                <div class="signalkit-setting-info">
                                    <strong><?php esc_html_e('Allow Dismissal', 'signalkit'); ?></strong>
                                    <p id="preferred-dismissible-desc"><?php esc_html_e('Users can close the banner', 'signalkit'); ?></p>
                                </div>
                            </div>

                            <div class="signalkit-setting-row">
                                <label for="preferred_close_button_size"><?php esc_html_e('Close Button Size (px)', 'signalkit'); ?></label>
                                <div class="signalkit-size-input inline">
                                    <input type="range" 
                            ...
                            <div class="signalkit-setting-row">
                                <label for="preferred_dismiss_duration"><?php esc_html_e('Dismiss Duration (days)', 'signalkit'); ?></label>
                                <input type="number" 
                                ...
                                <p class="description" id="preferred-dismiss-desc"><?php esc_html_e('How long to hide the banner after dismissal', 'signalkit'); ?></p>
                            </div>
                    ...
                    <div class="signalkit-tab-content" id="tab-global" data-content="global" role="tabpanel">
                        <div class="signalkit-settings-grid">
                            ...
                            <div class="signalkit-setting-row">
                                <label for="site_name"><?php esc_html_e('Site Name', 'signalkit'); ?></label>
                                <input type="text" 
                                       id="site_name"
                                ...
                                <p class="description" id="site-name-desc"><?php esc_html_e('Used in banner text when [site_name] placeholder is used', 'signalkit'); ?></p>
                            </div>
                            
                            <div class="signalkit-info-box">
                                <h3><?php esc_html_e('Plugin Information', 'signalkit'); ?></h3>
                            ...
                            <div class="signalkit-section-header">
                                <h3><span class="dashicons dashicons-smartphone" aria-hidden="true"></span> <?php esc_html_e('Mobile Banner Strategy', 'signalkit'); ?></h3>
                            </div>
                            ...
                            <div class="signalkit-section-header">
                                <h3><span class="dashicons dashicons-download" aria-hidden="true"></span> <?php esc_html_e('Import/Export Settings', 'signalkit'); ?></h3>
                            </div>
                            
                            <div class="signalkit-setting-row">
                                <p class="description"><?php esc_html_e('Backup and restore your settings easily', 'signalkit'); ?></p>
                    ...
                    <div class="signalkit-tab-content" id="tab-advanced" data-content="advanced" role="tabpanel">
                        <div class="signalkit-settings-grid">
                            ...
                            <!-- Hidden field to preserve setting for backwards compatibility -->
                            <input type="hidden" name="signalkit_settings[enable_csp]" value="0">
                            ...
                            <div class="signalkit-section-header">
                                <h3><span class="dashicons dashicons-chart-line" aria-hidden="true"></span> <?php esc_html_e('Analytics Settings', 'signalkit'); ?></h3>
                            </div>
                            ...
                            <div class="signalkit-setting-row">
                                ...
                                <div class="signalkit-setting-info">
                                    <strong><?php esc_html_e('Enable Analytics Tracking', 'signalkit'); ?></strong>
                                    <p id="analytics-desc"><?php esc_html_e('Track impressions, clicks, and dismissals for both banners', 'signalkit'); ?></p>
                                </div>
                            </div>
                            
                            <div class="signalkit-setting-row">
                                <label for="import_export_key"><?php esc_html_e('Import/Export Encryption Key', 'signalkit'); ?></label>
                                <input type="password" 
                                       ...
                                       autocomplete="off">
                                <p class="description" id="export-key-desc"><?php esc_html_e('Optional key for encrypting exported settings (for Envato/WordPress.org compatibility)', 'signalkit'); ?></p>
                            </div>
                            
                            <div class="signalkit-section-header">
                                <h3><span class="dashicons dashicons-database" aria-hidden="true"></span> <?php esc_html_e('Data Management', 'signalkit'); ?></h3>
                            </div>
                            
                            <div class="signalkit-setting-row signalkit-danger-zone">
                                <label class="signalkit-toggle">
                                    <input type="checkbox" 
                    ...
                    <?php submit_button(__('Save Settings', 'signalkit'), 'primary signalkit-submit-button'); ?>
        ...
        <div class="signalkit-preview-panel">
            <div class="signalkit-preview-header">
                <h3><span class="dashicons dashicons-visibility" aria-hidden="true"></span> <?php esc_html_e('Live Preview', 'signalkit'); ?></h3>
                <div class="signalkit-preview-controls" role="group" aria-label="<?php esc_attr_e('Preview device switcher', 'signalkit'); ?>">
                ...
                <div class="signalkit-preview-screen">
                    <div class="signalkit-preview-content">
                        <div class="signalkit-preview-placeholder">
                            ...
                            <p><?php esc_html_e('Your website content appears here', 'signalkit'); ?></p>
                        </div>
                    </div>
            ...
            <div class="signalkit-preview-info">
                <p class="description">
                    <span class="dashicons dashicons-info" aria-hidden="true"></span>
                    <?php esc_html_e('Changes appear instantly in the preview. Click Save Settings to apply changes to your live site.', 'signalkit'); ?>
                </p>
            </div>
        </div>
