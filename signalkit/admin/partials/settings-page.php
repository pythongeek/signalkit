                        ...
                        <div class="signalkit-settings-grid">
                            ...
                            <div class="signalkit-setting-row">
                                ...
                                <div class="signalkit-setting-info">
                                    ...
                                    <p id="follow-enabled-desc"><?php esc_html_e('Display the Google News Follow banner on your site', 'signalkit'); ?></p>
                                </div>
                            </div>
                    ...
                    <div class="signalkit-tab-content" id="tab-global" data-content="global" role="tabpanel">
                        <div class="signalkit-settings-grid">
                            ...
                            <div class="signalkit-info-box" style="background: #fff3cd; border-left-color: #ffc107;">
                                <h3><span class="dashicons dashicons-smartphone" aria-hidden="true"></span> <?php esc_html_e('Mobile Display Information', 'signalkit'); ?></h3>
                                <p><?php esc_html_e('When both banners are enabled on mobile devices:', 'signalkit'); ?></p>
                                <ul style="margin-left: 20px; list-style: disc;">
                                    <li><?php esc_html_e('Banners will stack vertically based on their Mobile Stack Order', 'signalkit'); ?></li>
                                    <li><?php esc_html_e('Order 1 appears closest to the edge (top/bottom)', 'signalkit'); ?></li>
                                    <li><?php esc_html_e('Order 2 appears second with appropriate spacing', 'signalkit'); ?></li>
                                    <li><?php esc_html_e('Full-width display ensures optimal mobile experience', 'signalkit'); ?></li>
                                </ul>
                            </div>
                    ...
                    <div class="signalkit-tab-content" id="tab-advanced" data-content="advanced" role="tabpanel">
                        <div class="signalkit-settings-grid">
                            ...
                            <div class="signalkit-setting-row">
                                ...
                                <div class="signalkit-setting-info">
                                    <strong><?php esc_html_e('Enable Content Security Policy (CSP)', 'signalkit'); ?></strong>
                                    <p id="csp-desc"><?php esc_html_e('Add CSP headers to prevent XSS attacks on banners', 'signalkit'); ?></p>
                                </div>
                            </div>
