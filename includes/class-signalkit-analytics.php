...
class SignalKit_Analytics {
    ...
    public static function track_impression($banner_type = 'follow') {
        ...
        if (self::is_rate_limited('impression')) {
            signalkit_log("Analytics ({$banner_type}): Rate limited impression", ['ip' => self::get_user_ip()]);
            return false;
        }
    ...
    public static function track_click($banner_type = 'follow') {
        ...
        if (self::is_rate_limited('click')) {
            signalkit_log("Analytics ({$banner_type}): Rate limited click", ['ip' => self::get_user_ip()]);
            return false;
        }
        ...
        try {
            ...
            if ($saved) {
                signalkit_log("Analytics ({$banner_type}): Click tracked", [
                    ...
                    'impressions' => $analytics[$banner_type]['impressions'] ?? 0,
    ...
    public static function track_dismissal($banner_type = 'follow') {
        ...
        if (self::is_rate_limited('dismissal')) {
            signalkit_log("Analytics ({$banner_type}): Rate limited dismissal", ['ip' => self::get_user_ip()]);
            return false;
        }
     ...
     * Matches implementation in class-signalkit-public.php
     *
