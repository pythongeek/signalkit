...
class SignalKit_Core {
    ...
    public function __construct() {
        ...
        $this->plugin_name = 'signalkit'; // Changed from 'signalkit-for-google' to match text domain
    ...
    private function define_public_hooks() {
        ...
        // Display banners in footer or body open (whichever fires first)
        // Priority 999999 ensures valid HTML structure even if footer is crowded
        $this->loader->add_action('wp_body_open', $plugin_public, 'display_banners', 999999);
        $this->loader->add_action('wp_footer', $plugin_public, 'display_banners', 999999);
