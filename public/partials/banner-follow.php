...
$signalkit_button_text     = esc_html($signalkit_banner['button_text'] ?? ''); // Added ?? '' for safety
$signalkit_google_news_url = esc_url_raw($signalkit_banner['button_url'] ?? ''); // Added ?? '' for safety
    ...
    <div class="signalkit-banner-content">
        ...
        <div class="signalkit-icon" role="img" aria-label="<?php esc_attr_e('Google News Icon', 'signalkit'); ?>">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                ...
                <path d="M24 13C18.48 13 14 17.48 14 23C14 28.52 18.48 33 24 33C29.52 33 34 28.52 34 23C34 17.48 29.52 13 24 13ZM27 28H21V26H27V28ZM27 24H21V18H27V24Z" fill="<?php echo esc_attr($signalkit_secondary_color); ?>"/>
            </svg>
        </div>
