 ...
 * Version: 2.1.1 - LIVE PREVIEW + MOBILE STACKING + CONSISTENT WITH FOLLOW BANNER
 *
...
$inline_styles = sprintf(
    ...
    '--signalkit-accent: %s; --signalkit-text: %s; --signalkit-width: %d%s; --signalkit-padding: %dpx; ' .
...
<div id="<?php echo esc_attr($banner_id); ?>"
    ...
    <div class="signalkit-banner-content">
        ...
        <div class="signalkit-icon" role="img" aria-label="<?php esc_attr_e('Preferred Source Star Icon', 'signalkit-for-google'); ?>">
            <svg width="100%" height="100%" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                <circle cx="24" cy="24" r="20" fill="var(--signalkit-primary)"/>
                <path d="M24 10L27.09 19.26L37 19.27L28.96 25.14L32.04 34.41L24 28.52L15.96 34.41L19.04 25.14L11 19.27L20.91 19.26L24 10Z" fill="var(--signalkit-secondary)"/>
            </</svg>
        </div>
